package com.practice.sber_practice.camunda.config;

import javax.sql.DataSource;

import com.practice.sber_practice.camunda.process.ProcessRequestDelegate;
import com.practice.sber_practice.services.CamundaRequestProcess;
...
public class EngineConfig {
    ...
    private static final String BPMN = "classpath:/bpmn/*.bpmn";
    @Bean
    ...
    public SpringProcessEngineConfiguration engineConfiguration(
            ...
            @Value(BPMN) Resource[] deploymentResources) {
