...
@Service
public class ProcessValidationRuleErrorDelegate implements JavaDelegate {
    @NonNull
    private DataStore dataStore;
    private static final String VALIDATION_SCHEME_ERROR_MESSAGE = "Ошибка при валидации запроса на соответствие бизнесс правилам";
    private static final String VALIDATION_SCHEME_ERROR_CAUSE = "Полученный запрос не отвечает требования бизнесс процесса";
    private static final String VALIDATION_SCHEME_ERROR_CODE = "ERR_CODE_002";
    @Override
